...
const Modal = () => {
    ...
    const style2 = isModalOpen ? 'opacity-50' : 'opacity-0';
    return (
        <>
            ...
            <div>
                <div className={`fixed ${style2} pointer-events-none transition-all ease-in-out duration-300 left-0 top-0 right-0 bottom-0 bg-black`}></div>
